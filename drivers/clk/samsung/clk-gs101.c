...
/*
 * gs201 CMU_TOP mux/div register-offset deltas vs gs101, per the AOSP cal-if
 * SFR table (cmucal-sfr.c, gs201): the shared-PLL fan-out dividers are uniformly
 * +0x28, and the HSI2_UFS_EMBD source mux is -0x4. Every other TOP mux/div/gate
 * offset matches gs101 1:1, so only these entries need a gs201 variant. gs101's
...
#define GS201_CLK_CON_DIV_PLL_SHARED0_DIV5		0x1934
#define GS201_CLK_CON_DIV_PLL_SHARED1_DIV2		0x1938
#define GS201_CLK_CON_DIV_PLL_SHARED1_DIV3		0x193c
#define GS201_CLK_CON_DIV_PLL_SHARED1_DIV4		0x1940
#define GS201_CLK_CON_DIV_PLL_SHARED2_DIV2		0x1944
#define GS201_CLK_CON_DIV_PLL_SHARED3_DIV2		0x1948
...
static const unsigned int gs201_top_skip_ids[] __initconst = {
	...
	/*
	 * NOTE: the shared-PLL fan-out dividers (SHARED0_DIV4/5, all of
	 * shared1/2/3) are NOT register-holes on gs201 — an earlier misread
	 * decoded them at the gs101 offsets (0x1908+), which land on unrelated
	 * registers. Their real gs201 offsets are +0x28 (see the GS201_CLK_CON_
	 * DIV_PLL_SHARED* macros and top_div_clks_gs201). They are now registered
	 * with the correct offsets, so they no longer need to be skipped.
	 */
};

/*
 * gs201 variant of top_mux_clks: identical to the gs101 table except the
 * HSI2_UFS_EMBD source mux, which lives at 0x10a8 (not 0x10ac) on gs201.
 */
static const struct samsung_mux_clock top_mux_clks_gs201[] __initconst = {
	MUX(CLK_MOUT_PLL_SHARED0, "mout_pll_shared0", mout_pll_shared0_p,
	    PLL_CON0_PLL_SHARED0, 4, 1),
	MUX(CLK_MOUT_PLL_SHARED1, "mout_pll_shared1", mout_pll_shared1_p,
	    PLL_CON0_PLL_SHARED1, 4, 1),
	...
	MUX(CLK_MOUT_CMU_HSI2_PCIE, "mout_cmu_hsi2_pcie", mout_cmu_hsi2_pcie0_p,
	    CLK_CON_MUX_MUX_CLKCMU_HSI2_PCIE, 0, 1),
	MUX(CLK_MOUT_CMU_HSI2_UFS_EMBD, "mout_cmu_hsi2_ufs_embd",
	    mout_cmu_hsi2_ufs_embd_p, GS201_CLK_CON_MUX_MUX_CLKCMU_HSI2_UFS_EMBD,
	    0, 2),
	MUX(CLK_MOUT_CMU_IPP_BUS, "mout_cmu_ipp_bus", mout_cmu_ipp_bus_p,
	    CLK_CON_MUX_MUX_CLKCMU_IPP_BUS, 0, 3),
	MUX(CLK_MOUT_CMU_ITP_BUS, "mout_cmu_itp_bus", mout_cmu_itp_bus_p,
...
/*
 * gs201 variant of top_div_clks: identical to the gs101 table except the nine
 * shared-PLL fan-out dividers, which are all +0x28 on gs201.
 */
static const struct samsung_div_clock top_div_clks_gs201[] __initconst = {
	DIV(CLK_DOUT_CMU_BO_BUS, "dout_cmu_bo_bus", "gout_cmu_bo_bus",
	    CLK_CON_DIV_CLKCMU_BO_BUS, 0, 4),
	DIV(CLK_DOUT_CMU_BUS0_BUS, "dout_cmu_bus0_bus", "gout_cmu_bus0_bus",
	    CLK_CON_DIV_CLKCMU_BUS0_BUS, 0, 4),
	...
	DIV(CLK_DOUT_CMU_CMU_CMUREF, "dout_cmu_cmuref", "gout_cmu_cmuref",
	    CLK_CON_DIV_DIV_CLK_CMU_CMUREF, 0, 2),
	DIV(CLK_DOUT_CMU_SHARED0_DIV2, "dout_cmu_shared0_div2",
	    "mout_pll_shared0", GS201_CLK_CON_DIV_PLL_SHARED0_DIV2, 0, 1),
	DIV(CLK_DOUT_CMU_SHARED0_DIV3, "dout_cmu_shared0_div3",
	    "mout_pll_shared0", GS201_CLK_CON_DIV_PLL_SHARED0_DIV3, 0, 2),
	DIV(CLK_DOUT_CMU_SHARED0_DIV4, "dout_cmu_shared0_div4",
	    "dout_cmu_shared0_div2", GS201_CLK_CON_DIV_PLL_SHARED0_DIV4, 0, 1),
	DIV(CLK_DOUT_CMU_SHARED0_DIV5, "dout_cmu_shared0_div5",
	    "mout_pll_shared0", GS201_CLK_CON_DIV_PLL_SHARED0_DIV5, 0, 3),
	DIV(CLK_DOUT_CMU_SHARED1_DIV2, "dout_cmu_shared1_div2",
	    "mout_pll_shared1", GS201_CLK_CON_DIV_PLL_SHARED1_DIV2, 0, 1),
	DIV(CLK_DOUT_CMU_SHARED1_DIV3, "dout_cmu_shared1_div3",
	    "mout_pll_shared1", GS201_CLK_CON_DIV_PLL_SHARED1_DIV3, 0, 2),
	DIV(CLK_DOUT_CMU_SHARED1_DIV4, "dout_cmu_shared1_div4",
	    "mout_pll_shared1", GS201_CLK_CON_DIV_PLL_SHARED1_DIV4, 0, 1),
	DIV(CLK_DOUT_CMU_SHARED2_DIV2, "dout_cmu_shared2_div2",
	    "mout_pll_shared2", GS201_CLK_CON_DIV_PLL_SHARED2_DIV2, 0, 1),
	DIV(CLK_DOUT_CMU_SHARED3_DIV2, "dout_cmu_shared3_div2",
	    "mout_pll_shared3", GS201_CLK_CON_DIV_PLL_SHARED3_DIV2, 0, 1),
};
...
static const struct samsung_cmu_info top_cmu_info_gs201 __initconst = {
	...
	.mux_clks		= top_mux_clks_gs201,
	.nr_mux_clks		= ARRAY_SIZE(top_mux_clks_gs201),
	.div_clks		= top_div_clks_gs201,
	.nr_div_clks		= ARRAY_SIZE(top_div_clks_gs201),
	.fixed_factor_clks	= top_ffactor_clks,
	.nr_fixed_factor_clks	= ARRAY_SIZE(top_ffactor_clks),
	.gate_clks		= top_gate_clks,
	.nr_gate_clks		= ARRAY_SIZE(top_gate_clks),
...
/*
 * gs201 CMU_HSI2 UFS gate-register offsets (per AOSP cal-if cmucal-sfr.c,
 * gs201): the UFS_EMBD I_* gates are +0x18 from gs101, the QE_UFS_EMBD gates
 * +0x14. The gs101 offsets above land on unrelated gs201 registers, so the
 * gs201 hsi2 gate table must use these. Only the UFS cluster is corrected
 * here (the block's other gates are unused on felix); gs101 stays untouched.
 */
#define GS201_CLK_CON_GAT_GOUT_BLK_HSI2_UID_UFS_EMBD_IPCLKPORT_I_ACLK		0x20e8
#define GS201_CLK_CON_GAT_GOUT_BLK_HSI2_UID_UFS_EMBD_IPCLKPORT_I_CLK_UNIPRO	0x20ec
#define GS201_CLK_CON_GAT_GOUT_BLK_HSI2_UID_UFS_EMBD_IPCLKPORT_I_FMP_CLK		0x20f0
#define GS201_CLK_CON_GAT_GOUT_BLK_HSI2_UID_QE_UFS_EMBD_HSI2_IPCLKPORT_ACLK	0x20a4
#define GS201_CLK_CON_GAT_GOUT_BLK_HSI2_UID_QE_UFS_EMBD_HSI2_IPCLKPORT_PCLK	0x20a8
...
/*
 * gs201 variant of hsi2_gate_clks: identical to the gs101 table except the
 * five UFS_EMBD gate-register offsets (corrected to gs201), and CLK_IS_CRITICAL
 * cleared on the UNIPRO gate so ufshcd clock-gating can disable it on idle
 * (the L2S_PLL_MIPI_UFS idle-power lever). The aclk/fmp/qe gates keep
 * CLK_IS_CRITICAL (UFS still sources those from fixed-clock stubs).
 */
static const struct samsung_gate_clock hsi2_gate_clks_gs201[] __initconst = {
	GATE(CLK_GOUT_HSI2_PCIE_GEN4_1_PCIE_003_PHY_REFCLK_IN,
	     "gout_hsi2_pcie_gen4_1_pcie_003_phy_refclk_in",
	     "mout_hsi2_pcie_user",
	     CLK_CON_GAT_CLK_BLK_HSI2_UID_PCIE_GEN4_1_IPCLKPORT_PCIE_003_PCIE_SUB_CTRL_INST_0_PHY_REFCLK_IN,
	...
	GATE(CLK_GOUT_HSI2_QE_UFS_EMBD_HSI2_ACLK,
	     "gout_hsi2_qe_ufs_embd_hsi2_aclk", "mout_hsi2_bus_user",
	     GS201_CLK_CON_GAT_GOUT_BLK_HSI2_UID_QE_UFS_EMBD_HSI2_IPCLKPORT_ACLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_HSI2_QE_UFS_EMBD_HSI2_PCLK,
	     "gout_hsi2_qe_ufs_embd_hsi2_pclk", "mout_hsi2_bus_user",
	     GS201_CLK_CON_GAT_GOUT_BLK_HSI2_UID_QE_UFS_EMBD_HSI2_IPCLKPORT_PCLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_HSI2_CLK_HSI2_BUS_CLK,
	     "gout_hsi2_clk_hsi2_bus_clk", "mout_hsi2_bus_user",
	     CLK_CON_GAT_GOUT_BLK_HSI2_UID_RSTNSYNC_CLK_HSI2_BUS_IPCLKPORT_CLK,
	...
	GATE(CLK_GOUT_HSI2_UFS_EMBD_I_ACLK,
	     "gout_hsi2_ufs_embd_i_aclk", "mout_hsi2_bus_user",
	     GS201_CLK_CON_GAT_GOUT_BLK_HSI2_UID_UFS_EMBD_IPCLKPORT_I_ACLK,
	     21, CLK_IS_CRITICAL, 0),
	GATE(CLK_GOUT_HSI2_UFS_EMBD_I_CLK_UNIPRO,
	     "gout_hsi2_ufs_embd_i_clk_unipro", "mout_hsi2_ufs_embd_user",
	     GS201_CLK_CON_GAT_GOUT_BLK_HSI2_UID_UFS_EMBD_IPCLKPORT_I_CLK_UNIPRO,
	     21, 0, 0),
	GATE(CLK_GOUT_HSI2_UFS_EMBD_I_FMP_CLK,
	     "gout_hsi2_ufs_embd_i_fmp_clk", "mout_hsi2_bus_user",
	     GS201_CLK_CON_GAT_GOUT_BLK_HSI2_UID_UFS_EMBD_IPCLKPORT_I_FMP_CLK,
	     21, CLK_IS_CRITICAL, 0),
	/* TODO: should have a driver for this */
	GATE(CLK_GOUT_HSI2_XIU_D_HSI2_ACLK,
	     "gout_hsi2_xiu_d_hsi2_aclk", "mout_hsi2_bus_user",
...
/*
 * gs201 CMU_HSI2 info: as hsi2_cmu_info but with the gs201 UFS gate table.
 */
static const struct samsung_cmu_info hsi2_cmu_info_gs201 __initconst = {
	.mux_clks		= hsi2_mux_clks,
	.nr_mux_clks		= ARRAY_SIZE(hsi2_mux_clks),
	.gate_clks		= hsi2_gate_clks_gs201,
	.nr_gate_clks		= ARRAY_SIZE(hsi2_gate_clks_gs201),
